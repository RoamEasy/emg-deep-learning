...
chip1Config = [exgSamplingRate, 0xA0, 0x10, 0x69, 0x60, 0x20, 0x00, 0x00, 0x02, 0x03]

# Chip 2 configuration
#chip2Config = [exgSamplingRate, 0xA3, 0x10, exgGainValue, exgGainValue, 0x00, 0x00, 0x00, 0x02, 0x01]
chip2Config = [exgSamplingRate, 0xA0, 0x10, 0xE1, 0xE1, 0x00, 0x00, 0x00, 0x02, 0x01]
...
if len(sys.argv) < 2:
	...
	*************************
	...
	data_writer.writerow(["Date_Time", "CH_1_mV", "CH_2_mV"])
