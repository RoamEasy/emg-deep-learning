...
By using deep learning to predict non-audible speech...
...
In ~\cite{wand_pattern_2014}, new approaches to  machine learning models were introduced, such as Restricted Boltzmann Machine algorithms. Their corpus consisted of 25 sessions from
