...
\multirow{2}{*}{\# of class} &\multirow{2}{*}{type}    & \multicolumn{2}{c|}{Trained Data}    &\multicolumn{2}{c|}{Test Data}                    \\   \cline{3-6}
 &  &{Prec.} & {Rec.} & {Prec.}  & {Rec.}              \\   \hline 
\multirow{2}{*}{2} & no & 0.96 & 0.87 & 0.85  & 0.79   \\   \cline{2-6}  
 & yes & 0.87 & 0.96 & 0.83   & 0.88                \\   \hline
 \multicolumn{2}{|c|}{Average}   & 0.92 & 0.91 & 0.84 & 0.84 \\ \hline 
 \end{tabular}     
...
\multirow{2}{*}{\# of class} &\multirow{2}{*}{type}    & \multicolumn{3}{c|}{1-D CNN}    &\multicolumn{3}{c|}{CWT-CNN}  &\multicolumn{3}{c|}{LSTM} &\multicolumn{3}{c|}{BI-LSTM}                   \\   \cline{3-14}
 &  &{Prec.} & {Rec.} & {F1} &{Prec.} & {Rec.} & {F1} &{Prec.} & {Rec.} & {F1} &{Prec.} & {Rec.} & {F1}             \\   \hline 
\multirow{2}{*}{2} & no & 0.85 & 0.79 & 0.82  & 0.75 & 0.72 & 0.73 & 0.60 & 0.83 & 0.70 & 0.49 & 0.62 & 0.55 \\   \cline{2-14}  
 & yes & 0.83 & 0.88 & 0.85  & 0.77 & 0.52 & 0.63 & 0.77 & 0.52 & 0.62 & 0.56 & 0.42 & 0.48         \\   \hline
 \multicolumn{2}{|c|}{Average}   & 0.84 & 0.84 & 0.84 & 0.76 & 0.76 & 0.68 & 0.69 & 0.66 & 0.66 &  0.53  & 0.52 & 0.51\\ \hline 
 \end{tabular}     
